...
namespace Microsoft.EntityFrameworkCore.Migrations.Internal
{
    ...
    /// </summary>
    public class TestMigrationsModelDiffer : IMigrationsModelDiffer
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public TestMigrationsModelDiffer(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(IEnumerable<string> source, IEnumerable<string> target, DiffContext diffContext)
            => DiffCollection(
                source,
                target,
                diffContext,
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(string source, string target, DiffContext diffContext)
            => Enumerable.Empty<MigrationOperation>();
        ...
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(
            IEnumerable<TableMapping> source,
            IEnumerable<TableMapping> target,
            DiffContext diffContext)
            => DiffCollection(
                source,
                target,
        ...
        protected virtual IEnumerable<MigrationOperation> Remove(
            TableMapping source, DiffContext diffContext)
        {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(IProperty source, IProperty target, DiffContext diffContext)
        {
            var sourceAnnotations = source.Relational();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Remove(IProperty source, DiffContext diffContext)
        {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Add(IKey target, DiffContext diffContext)
        {
            var targetAnnotations = target.Relational();
            var targetEntityTypeAnnotations = target.DeclaringEntityType.RootType().Relational();
        ...
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(
            IForeignKey source, IForeignKey target, DiffContext diffContext)
            => Enumerable.Empty<MigrationOperation>();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Remove(IIndex source, DiffContext diffContext)
        {
            var sourceEntityTypeAnnotations = source.DeclaringEntityType.RootType().Relational();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual IEnumerable<MigrationOperation> Diff(ISequence source, ISequence target, DiffContext diffContext)
        {
            if (source.Schema != target.Schema
                || source.Name != target.Name)
            {
                    ...
                    foreach (var targetKey in targetKeys)
                    {
                        ...
                        foreach (var targetEntry in targetTableEntryMappingMap.GetOrAddValue(entry))
                        {
                            ...
                            foreach (var targetProperty in targetEntry.EntityType.GetProperties())
                            {
                                ...
                                {
                                    targetEntry.SetOriginalValue(targetProperty, targetProperty.ClrType.AsDefaultValue());
                                }
                            }
        ...
        protected virtual object GetDefaultValue(Type type)
            => type == typeof(string)
                ...
                : type.IsArray
                    ...
                    : type.UnwrapNullableType().AsDefaultValue();
    ...
    public static class DefaultTestExtensions
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
