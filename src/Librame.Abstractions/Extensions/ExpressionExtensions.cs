...
namespace Librame.Extensions
{
    ...
    public static class ExpressionExtensions
    {
        ...
        {
            propertyExpression.NotDefault(nameof(propertyExpression));
        ...
        public static TValue AsPropertyValue<T, TValue>(this T entity, Expression<Func<T, TValue>> propertyExpression)
        {
            entity.NotDefault(nameof(entity));
        ...
        {
            compareToFactory.NotDefault(nameof(compareToFactory));
