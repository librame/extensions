...
namespace Librame.Extensions.Drawing
{
    ...
    /// 默认图画构建器选项。
    /// </summary>
    public class DefaultDrawingBuilderOptions : IDrawingBuilderOptions
    {
        /// <summary>
        /// 图像格式（默认为 JPEG）。
        /// </summary>
        ...
        /// 缩放选项。
        /// </summary>
        public IList<ScaleOptions> Scales { get; set; } = new List<ScaleOptions>
        {
            new ScaleOptions
            {
                Suffix = "-small",
    ...
    public class CaptchaOptions
    {
        ...
        /// 字体。
        /// </summary>
        public FontOptions Font { get; set; } = new FontOptions { Size = 16 };
    ...
    public class ScaleOptions
    {
        ...
        /// 水印模式。
        /// </summary>
        public WatermarkMode Watermark { get; set; } = WatermarkMode.None;

        /// <summary>
        /// 最大尺寸。
        /// </summary>
        public Size MaxSize { get; set; } = new Size(100, 70);
    }
    ...
    public class WatermarkOptions
    {
        ...
        /// 水印文本。
        /// </summary>
        public string Text { get; set; } = "librame.net";
        ...
        /// 水印位置（负值表示反向）。
        /// </summary>
        public Point Location { get; set; } = new Point(20, 5);
    ...
    public class ColorOptions
    {
        ...
        /// 前景色。
        /// </summary>
        public string ForeHex { get; set; } = "#0066cc";

        /// <summary>
        /// 交替色。
        /// </summary>
        public string AlternateHex { get; set; } = "#993366";

        /// <summary>
        /// 背景色。
        /// </summary>
        public string BackgroundHex { get; set; } = "#ccffff";

        /// <summary>
        /// 干扰色。
        /// </summary>
        public string DisturbingHex { get; set; } = "#99ccff";
    }
    ...
    public class NoiseOptions
    {
        ...
        /// 间距。
        /// </summary>
        public PointF Space { get; set; } = new PointF
        {
            X = 5,
            Y = 5
        };
