...
{
    internal class InternalWebSocketClientHandler : SimpleChannelInboundHandler<object>
    {
        ...
        public InternalWebSocketClientHandler(IWebSocketClient client,
            WebSocketClientHandshaker handshaker)
        {
            _client = client;
            _logger = client.LoggerFactory.CreateLogger<InternalWebSocketClientHandler>();
