...
{
    internal class InternalTelnetClientHandler : SimpleChannelInboundHandler<string>
    {
        private readonly ITelnetClient _client;
        private readonly ILogger _logger;


        public InternalTelnetClientHandler(ITelnetClient client)
            : base()
        {
            _client = client;
            _logger = client.LoggerFactory.CreateLogger<InternalTelnetClientHandler>();
        }
