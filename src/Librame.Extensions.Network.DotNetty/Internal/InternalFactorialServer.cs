...
namespace Librame.Extensions.Network.DotNetty.Internal
{
    ...
    /// 内部析因服务端通道服务。
    /// </summary>
    internal class InternalFactorialServer : AbstractChannelService<InternalFactorialServer>, IFactorialServer
    {
        private readonly ServerOptions _serverOptions;


        /// <summary>
        /// 构造一个 <see cref="InternalFactorialServer"/> 实例。
        /// </summary>
        ...
        public InternalFactorialServer(ISigningCredentialsProvider provider,
        ...
        {
            handlerFactory = handlerFactory.AsValueOrDefault(() => new InternalFactorialServerHandler(this));
