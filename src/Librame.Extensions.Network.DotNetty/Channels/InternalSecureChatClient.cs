...
namespace Librame.Extensions.Network.DotNetty
{
    ...
    /// 内部安全聊天客户端通道服务。
    /// </summary>
    internal class InternalSecureChatClient : AbstractChannelService<InternalSecureChatClient>, ISecureChatClient
    {
        private readonly ClientOptions _clientOptions;


        /// <summary>
        /// 构造一个 <see cref="InternalSecureChatClient"/> 实例。
        /// </summary>
        ...
        public InternalSecureChatClient(ISigningCredentialsProvider provider,
        ...
        {
            handlerFactory = handlerFactory.AsValueOrDefault(() => new InternalSecureChatClientHandler(this));
