...
namespace Librame.MediaInfo.Tracks
{
    ...
    /// 菜单轨道信息。
    /// </summary>
    public class MenuTrackInfo : AbstarctTrackInfo<MenuTrackInfo>, ITrackInfo
    {
        /// <summary>
        /// 构造一个 <see cref="MenuTrackInfo"/> 实例。
        /// </summary>
        /// <param name="baseTrack">给定的轨道字典集合。</param>
        public MenuTrackInfo(IDictionary<string, string> baseTrack)
            : base(baseTrack)
        {
        }
