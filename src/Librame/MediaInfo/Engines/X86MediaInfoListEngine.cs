...
namespace Librame.MediaInfo.Engines
{
    ...
    /// 32 位 MediaInfo 列表引擎。
    /// </summary>
    public class X86MediaInfoListEngine : AbstractMediaInfoEngine, IMediaInfoListEngine
    {
        // Import of DLL functions. DO NOT USE until you know what you do
        // (MediaInfo DLL do NOT use CoTaskMemAlloc to allocate memory)
        [DllImport(X86MediaInfoEngine.DLL_FILENAME)]
        ...
        /// <summary>
        /// 构造一个 <see cref="X86MediaInfoListEngine"/> 实例。
        /// </summary>
        public X86MediaInfoListEngine()
            : base(X86MediaInfoEngine.DLL_FILENAME)
        {
            _handle = MediaInfoList_New();
        }
        /// <summary>
        /// 解构一个 <see cref="X86MediaInfoListEngine"/> 实例。
        /// </summary>
        ~X86MediaInfoListEngine()
        {
