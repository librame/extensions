...
namespace Librame.Threads
{
    ...
    /// 简单线程池。
    /// </summary>
    public class SimpleThreadPool : AbstractDisposable<SimpleThreadPool>, ISimpleThreadPool
    {
        ...
        /// <summary>
        /// 构造一个 <see cref="SimpleThreadPool"/> 实例。
        /// </summary>
        ...
        public SimpleThreadPool(ConcurrentQueue<JobDescriptor> jobs)
        ...
        public SimpleThreadPool(int threadsCount)
        ...
        /// <param name="jobs">给定的 <see cref="ConcurrentQueue{JobDescriptor}"/>。</param>
        /// <param name="threadsCount">给定的线程数量（推荐使用 CPU 核心数+2，）。</param>
        public SimpleThreadPool(ConcurrentQueue<JobDescriptor> jobs, int threadsCount)
            : base()
        {
            Enabled = true;
