...
namespace Librame.Forms.Material
{
    ...
    public class MaterialCheckBox : CheckBox, IMaterialControl
    {
        ...
        /// <summary>
        /// 构造一个 <see cref="MaterialCheckBox"/> 实例。
        /// </summary>
        ...
        {
            int w = boxOffset + CHECKBOX_SIZE + 2 + (int)CreateGraphics().MeasureString(Text, Skin.Scheme.Fonts.Medium10).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
			...
			var brush3 = new SolidBrush(Enabled ? Skin.Scheme.Colors.Accent : Skin.Scheme.CheckboxOff.Disabled.Color);
            ...
            {
                SolidBrush brush2 = new SolidBrush(DrawHelper.BlendColor(Parent.BackColor, Enabled ? Skin.Scheme.CheckboxOff.Enable.Color : Skin.Scheme.CheckboxOff.Disabled.Color, backgroundAlpha));
            ...
            g.DrawString(
                ...
                Enabled ? Skin.Scheme.Texts.Primary.Brush : Skin.Scheme.Texts.DisabledOrHint.Brush,
