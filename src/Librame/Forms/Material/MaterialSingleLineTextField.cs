    ...
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        public MaterialSingleLineTextField()
        {
            ...
            BackColorChanged += (sender, args) =>
            {
                ...
                baseTextBox.ForeColor = Skin.Scheme.Texts.Primary.Color;
            };
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                //No animation
				g.FillRectangle(baseTextBox.Focused ? Skin.Scheme.Brushes.Primary : Skin.Scheme.Texts.Dividers.Brush, baseTextBox.Location.X, lineY, baseTextBox.Width, baseTextBox.Focused ? 2 : 1);
            }
            else
            {
                //Animate
                ...
                g.FillRectangle(Skin.Scheme.Texts.Dividers.Brush, baseTextBox.Location.X, lineY, baseTextBox.Width, 1);

                //Animated focus transition
				g.FillRectangle(Skin.Scheme.Brushes.Primary, animationStart - halfAnimationWidth, lineY, animationWidth, 2);
            }
        }
