...
namespace System.Linq
{
    ...
    public static class QueryableExtensions
    {
        ...
        public static T AsOne<T>(this IQueryable<T> query, Expression<Func<T, bool>> predicate = null,
            bool isUnique = true)
        {
            // 唯一性约束
            if (isUnique)
        ...
        /// <returns>返回一个查询接口。</returns>
        public static IQueryable<T> AsOrder<T>(this IQueryable<T> query, Action<Orderable<T>> order = null)
        {
            // 如果不排序，则直接返回
