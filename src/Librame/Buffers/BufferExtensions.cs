...
namespace Librame.Extensions
{
    ...
    public static class BufferExtensions
    {
        ...
        public static IBuffer<T> AsDefaultBuffer<T>(this T[] elements)
        {
        ...
        public static IReadOnlyBuffer<T> AsDefaultReadOnlyBuffer<T>(this T[] elements)
        {
        ...
        public static IStringBuffer AsDefaultStringBuffer(this string str, ILoggerFactory loggerFactory = null)
        {
        ...
        public static IStringReadOnlyBuffer AsDefaultStringReadOnlyBuffer(this string str, ILoggerFactory loggerFactory = null)
        {
            if (loggerFactory.IsDefault())
                loggerFactory = new LoggerFactory();
        ...
        {
            return base64String.FromBase64String().AsDefaultBuffer();
        }
        ...
        {
            return hexString.FromHexString().AsDefaultBuffer();
        }
