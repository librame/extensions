...
namespace Librame.Utility.TypeConverters
{
    ...
    public class GuidTypeConverter : TypeConverter
    {
        ...
        /// <param name="value">给定的 <see cref="Guid"/>。</param>
        /// <param name="destinationType">给定的目标类型。</param>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(string))
            {
                ...
                // D=连字符分隔的 32 位数字： xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
                // B={D}
                // P=(D)
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            // no value so we return a new Guid instance
            if (value == null)
                return defaultGuid;
            ...
            if (value is string)
            {
                ...
                // empty string so we return a new Guid instance
                if (str.Length <= 0)
                    return defaultGuid;

                try
                {
                    // create a new Guid instance with these values and return it
