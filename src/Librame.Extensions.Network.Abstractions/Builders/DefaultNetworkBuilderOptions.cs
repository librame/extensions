...
namespace Librame.Extensions.Network
{
    ...
    /// 默认网络构建器选项。
    /// </summary>
    public class DefaultNetworkBuilderOptions : DefaultEncryptionBuilderOptions, INetworkBuilderOptions
    {
        /// <summary>
        /// 抓取器选项。
        /// </summary>
    ...
    public class EmailOptions
    {
        ...
        /// 邮箱地址。
        /// </summary>
        public string EmailAddress { get; set; } = "myemail@contoso.com";

        /// <summary>
        /// 显示名称。
        /// </summary>
        public string DisplayName { get; set; } = "MyEmail";
    ...
    public class SmsOptions
    {
        ...
        /// </summary>
        public int ContinueTimeout { get; set; } = 10000;

        /// <summary>
        /// 网关链接。
        /// </summary>
        public string GetewayUrl { get; set; } = "https://sms.contoso.com";
    }
    ...
    public class SmtpOptions
    {
        ...
        /// 服务器。
        /// </summary>
        public string Server { get; set; } = "smtp.contoso.com";
        ...
        /// 网络凭据。
        /// </summary>
        public NetworkCredential Credential { get; set; } = new NetworkCredential("LoginName", "LoginPass");
    }
