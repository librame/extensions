...
namespace Librame.Extensions.Data.Stores
{
    ...
    /// </summary>
    public class GuidDataStoreInitializer : GuidDataStoreInitializer<DbContextAccessor>
    {
        /// <summary>
        /// 构造一个数据存储初始化器。
        /// </summary>
    ...
    public class GuidDataStoreInitializer<TAccessor> : GuidDataStoreInitializer<TAccessor, int>
