...
namespace Librame.Extensions.Data.Migrations
{
    ...
    public class ResetMigrationsModelDiffer : IMigrationsModelDiffer
    {
            ...
            [NotNull] DiffContext diffContext)
        {
            ...
            var targetKeys = target.EntityTypes.SelectMany(Microsoft.EntityFrameworkCore.EntityTypeExtensions.GetDeclaredKeys)
            ...
            public DiffContext(IModel source, IModel target)
            {
                ...
                if (source != null && target != null)
                {
                    ...
                    foreach (var targetEntityType in targetEntityTypes)
                    {
                        ...
                        var sourceMap = _sourceEntitiesMap[sourceEntityType];
                        var targetMap = _targetEntitiesMap[targetEntityType];
