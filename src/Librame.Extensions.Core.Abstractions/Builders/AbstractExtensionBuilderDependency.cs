...
namespace Librame.Extensions.Core.Builders
{
    ...
    public abstract class AbstractExtensionBuilderDependency<TOptions> : AbstractDependency, IExtensionBuilderDependency
        where TOptions : class, IExtensionBuilderOptions
    {
        ...
        /// 构建器选项依赖。
        /// </summary>
        public OptionsDependency<TOptions> Builder { get; }
            = new OptionsDependency<TOptions>();
    }
}
