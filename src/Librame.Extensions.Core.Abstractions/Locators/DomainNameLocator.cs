...
namespace Librame.Extensions.Core
{
    ...
    /// 域名定位器。
    /// </summary>
    public class DomainNameLocator : AbstractLocator<string>
    {
        ...
        public DomainNameLocator ChangeDomainName(string newDomainName)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator ChangeRoot(string newRoot)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator ChangeTopLevelSegment(string newTopLevelSegment)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator ChangeSecondLevelSegment(string newSecondLevelSegment)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator ChangeThirdLevelSegment(string newThirdLevelSegment)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator ChangeOtherLevelSegments(params string[] newOtherLevelSegments)
        {
        ...
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewDomainName(string newDomainName)
        {
            var newLevelSegments = ParseAllLevelSegments(newDomainName);

            var copyLocator = new DomainNameLocator(new List<string>(_allLevelSegments));
        ...
        /// <param name="newRoot">给定的根（如：com/org...）。</param>
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewRoot(string newRoot)
        {
        ...
        /// <param name="newTopLevelSegment">给定的新顶级/一级片段（如：top.com/top.org... 中的 top）。</param>
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewTopLevelSegment(string newTopLevelSegment)
        {
        ...
        /// <param name="newSecondLevelSegment">给定的二级片段（如：second.top.com/second.top.org... 中的 second）。</param>
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewSecondLevelSegment(string newSecondLevelSegment)
        {
        ...
        /// <param name="newThirdLevelSegment">给定的三级片段（如：third.second.top.com/third.second.top.org... 中的 third）。</param>
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewThirdLevelSegment(string newThirdLevelSegment)
        {
        ...
        /// <param name="newOtherLevelSegments">给定的新其他级别片段集合（除三级外所有子级）。</param>
        /// <returns>返回 <see cref="DomainNameLocator"/>。</returns>
        public DomainNameLocator NewOtherLevelSegments(params string[] newOtherLevelSegments)
        {
