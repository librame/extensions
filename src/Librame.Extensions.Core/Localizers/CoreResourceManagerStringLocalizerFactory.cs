...
namespace Librame.Extensions.Core.Localizers
{
    ...
    public class CoreResourceManagerStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        public CoreResourceManagerStringLocalizerFactory(IOptions<LocalizationOptions> localizationOptions,
        ...
        {
            var resourceManager = new CoreResourceManager(baseName, assembly, _loggerFactory.CreateLogger<CoreResourceManager>());
