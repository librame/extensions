...
namespace Librame.Extensions.Data
{
    ...
    /// 默认审计解析器服务。
    /// </summary>
    public class DefaultAuditResolverService : AbstractService<DefaultAuditResolverService>, IAuditResolverService
    {
        /// <summary>
        /// 构造一个 <see cref="DefaultAuditResolverService"/> 实例。
        /// </summary>
        /// <param name="logger">给定的 <see cref="ILogger{DefaultAuditResolverService}"/>。</param>
        public DefaultAuditResolverService(ILogger<DefaultAuditResolverService> logger)
            : base(logger)
        {
        }
